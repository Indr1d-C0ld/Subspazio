...
<div class="game-grid plancia-grid">
  <section class="panel">
    <h1><span class="sec-ic">🔩</span> Slot dello scafo<?= partial('help', ['key' => 'moduli.slot']) ?></h1>
  ...
  <section class="panel">
    <h1><span class="sec-ic">🧳</span> Inventario moduli<?= partial('help', ['key' => 'moduli.inventario']) ?></h1>
    <?php if ($inventory === []): ?>
...
<?php if (!empty($jobs)): ?>
<section class="panel">
  <h2><span class="sec-ic">🏭</span> Officina — lavori in corso <span class="mut"><?= count($jobs) ?>/<?= (int) ($max_jobs ?? 3) ?></span><?= partial('help', ['key' => 'moduli.lavori']) ?></h2>
...
<section class="panel">
  <h1><span class="sec-ic">⚗️</span> Raffineria &amp; produzione<?= partial('help', ['key' => 'moduli.raffineria']) ?></h1>
  <?php if (!$at_dock): ?>
  ...
  <h2><span class="sec-ic">📘</span> Ricette<?= partial('help', ['key' => 'moduli.raffineria']) ?></h2>
